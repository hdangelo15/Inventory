...
/**
 * Controller class for the Add Product portion of the application.
...
public class AddProduct implements Initializable {
    ...
    /**
     * A list that contains the parts associated with the product.
     * */
    ...
    /**
     * Cancels the new product and returns the user to the main menu.
    ...
    void onActionCancel(ActionEvent event) throws IOException {
        ...
        alert.setContentText("Do you want cancel Add Product and return to the main menu?");
    ...
    /**
     * Adds a new product to the inventory and takes the user back to the main menu.
