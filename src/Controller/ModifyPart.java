...
/**
 * Controller for the Modify Part screen of the application.
...
public class ModifyPart implements Initializable {
    ...
    /**
     * The part to be modified as selected on the Main Menu screen.
     * */
    ...
    /**
     * Cancels the Modify Part form and returns the user to the main menu after confirmation.
    ...
    void onActionCancel(ActionEvent event) throws IOException {
        ...
        alert.setContentText("Do you want cancel Modify Part and return to the main menu?");
    ...
    /**
     * Updates the selected part in the inventory and returns the user to the main menu.
    ...
    /**
     * Displays various alert messages depending on the case.
     * @param alertType
     * */
    ...
    /**
     * Initializes the Modify Part controller and populates the text fields with the values of the part selected from the Main Menu.
     * @param url
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        selectedPart = MainMenu.getPartToModify();

        if (selectedPart instanceof InHouse) {
            inhousePartRB.setSelected(true);
            partOriginLabel.setText("Machine ID");
            partOriginTxt.setText(String.valueOf(((InHouse) selectedPart).getMachineid()));
        }

        if (selectedPart instanceof Outsourced){
            outsourcedPartRB.setSelected(true);
            partOriginLabel.setText("Company Name");
            partOriginTxt.setText(((Outsourced) selectedPart).getCompanyName());
        }
